/*
 * lib9.h for AMD64 (x86_64) Linux
 * Based on Linux/arm64/include/lib9.h
 * Proper 64-bit types for x86_64
 */
...
/*
 * math module dtoa - x86_64 is little endian
...
/*
 * x86_64 has 64-bit long, so we need USE_FPdbleword
